...
#define CC2500_GET_GDO0()				GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_4)
#define CC2500_GET_GDO2()				GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_5)

//PB12-CS 
#define CC2500_NoSelect()  GPIO_SetBits(GPIOB, GPIO_Pin_12)
#define CC2500_Select()  GPIO_ResetBits(GPIOB, GPIO_Pin_12)

/**
*@brief  cc2500 settings
*@
**/
